...
func TestHumanSize(t *testing.T) {
	for i, v := range map[float64]string{
		...
		1000000000000000000000:    "1 z",
		1000000000000000000000000: "1 y",
		math.MaxFloat64:           " y",
	} {
		o := HumanSize(i, 1000, []string{"", " k", " m", " g", " t", " p", " e", " z", " y"})
		if o != v {
